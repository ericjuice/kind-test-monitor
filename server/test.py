...
class TestHostOperator(unittest.TestCase):
    ...
    # eg: python3 -m unittest test.TestHostOperator.test_fetch_data_and_gen_flame_from_db
    def test_fetch_data_and_gen_flame_from_db(self):
        h = HostOperator()
        res = h.fetch_data_and_gen_flame_from_db()
        print(res)
